        ...
        <table id='example1' class='table table-bordered table-striped'>
          ...
          while ($row = $sel->fetch_assoc()):
            ...
            <tr>
              ...
              <td><?php echo $row['hCustodian']; ?></td>
              <td><?php echo $row['studentType']; ?></td>
              <td><?php echo $row['hEmail']; ?></td>
              <td><?php echo $row['status']; ?></td>
              <td>
                <a href="reject.php?Approve=<?php echo $row['hostelId'];?>" class="btn btn-info">Approve</a>
                <a href="reject.php?Reject=<?php echo $row['hostelId'];?>" class="btn btn-danger">Reject</a>
              </td>
            </tr>
          <?php endwhile; ?>
        </table>
