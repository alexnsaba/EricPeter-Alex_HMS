...
if(isset($_POST['register'])){
		...
		$a= mysqli_query($con,"select * from hostel where hEmail='$hEmail' and hPhone='$hPhone'");
     ...
     if (getimagesize($_FILES['image']['tmp_name']) == FALSE) {
      ...
      echo "Please select an image.";
		 ...
		 if($num1>0){
			 echo "<br/><h2>Either Hostel Email or phone number exists. try another email and phone number</h2>";
		 }
		 else{
          ...
          if ($result) {
            # code...
            echo "<br/><h2>Hostel ".$hName." is now successfully registered..</h2>";
          }else{
        echo "<br/><h2>Sorry the hostel could not be registered. please try again</h2>";
        }
	 }
